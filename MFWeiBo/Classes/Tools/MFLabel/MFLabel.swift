...
@objc
public protocol MFLabelDelegate: NSObjectProtocol {
    /// 选中链接文本
    ///
    /// - parameter label: label
    /// - parameter text:  选中的文本
    @objc optional func labelDidSelectedLinkText(label: MFLabel, text: String)
}
...
public class MFLabel: UILabel {
    ...
    public weak var delegate: MFLabelDelegate?
